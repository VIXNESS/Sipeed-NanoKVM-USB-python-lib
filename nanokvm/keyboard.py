...
KEYCODE_MAP: dict[str, int] = {
    ...
    "BracketRight": 0x30, "Backslash": 0x31, "IntlHash": 0x32,
    ...
    # System / Edit
    "Execute": 0x74, "Help": 0x75, "Props": 0x76, "Select": 0x77,
    "Stop": 0x78, "Again": 0x79, "Undo": 0x7A, "Cut": 0x7B,
    "Copy": 0x7C, "Paste": 0x7D, "Find": 0x7E,
    # Media / Volume
    ...
    "Lang4": 0x93, "Lang5": 0x94,
    # Numpad extended
    "NumpadParenLeft": 0xB6, "NumpadParenRight": 0xB7,
    "NumpadBackspace": 0xBB,
    "NumpadMemoryStore": 0xD0, "NumpadMemoryRecall": 0xD1,
    "NumpadMemoryClear": 0xD2, "NumpadMemoryAdd": 0xD3,
    ...
    "WinLeft": 0xE3, "ControlRight": 0xE4, "ShiftRight": 0xE5,
    "AltRight": 0xE6, "MetaRight": 0xE7, "WinRight": 0xE7,
}
...
CHAR_CODES: dict[int, int] = {
    ...
    85: 0x18, 86: 0x19, 87: 0x1A, 88: 0x1B, 89: 0x1C, 90: 0x1D,
    # a-z
    97: 0x04, 98: 0x05, 99: 0x06, 100: 0x07, 101: 0x08,
    102: 0x09, 103: 0x0A, 104: 0x0B, 105: 0x0C, 106: 0x0D,
    107: 0x0E, 108: 0x0F, 109: 0x10, 110: 0x11, 111: 0x12,
    112: 0x13, 113: 0x14, 114: 0x15, 115: 0x16, 116: 0x17,
    117: 0x18, 118: 0x19, 119: 0x1A, 120: 0x1B, 121: 0x1C, 122: 0x1D,
    # Symbols
    32: 0x2C,   # Space
    33: 0x1E,   # !
    34: 0x34,   # "
